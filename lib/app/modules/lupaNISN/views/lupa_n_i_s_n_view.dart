...
class LupaNISNView extends GetView<LupaNISNController> {
  @override
  Widget build(BuildContext context) {
    final double height = MediaQuery.of(context).size.height;
    return SafeArea(
      child: Scaffold(
          body: GetBuilder<LupaNISNController>(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Container(
                                  width: 280,
                                  child: Text(
                                    "Silahkan masukkan email yang sudah dibuat untuk mereset NISN",
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ElevatedButton(
                                        ...
                                        onPressed: () =>
                                            Get.toNamed(Routes.NEW_N_I_S_N),
                                        child: Text("KIRIM")),
                                  ),
                                ],
                              ),
